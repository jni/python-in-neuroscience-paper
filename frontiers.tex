...
{\small
\begin{minted}[linenos, numbersep=5pt, samepage=true]{python}
# imports
...
{\small
\begin{minted}[linenos, numbersep=5pt, firstnumber=31, samepage=true]{python}
...
{\small
\begin{minted}[linenos, numbersep=5pt, firstnumber=44, samepage=true]{python}
